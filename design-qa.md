...
## 2026-09-01 — No-task official-control compatibility candidate
...
- Boundary: this is static and offline compatibility evidence only. A separately authorized installation/injection and a user-observed new-unsent-task selection followed by first-task creation remain the live acceptance gate.

candidate result: build-7377 compatibility repair implemented and offline-green; live no-task acceptance not tested
