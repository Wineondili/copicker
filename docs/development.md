...
| Renderer development candidate | `0.12.13` | `model-rail.js` `VERSION`; corrects the live-observed `"default"` Standard tier and legacy-Daybreak mutation blockers while retaining the build-`7377` proxy and animation |
